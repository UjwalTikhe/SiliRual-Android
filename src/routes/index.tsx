...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "An accessible companion for activities, memories, reminders and trusted care.",
      },
      { property: "og:title", content: "SiliRual — Everyday Support with Care" },
      {
        property: "og:description",
        content:
          "A calm, accessible companion designed for elders and the people who care for them.",
      },
